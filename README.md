...
3.1.* `Преимущества у NewSQL систем перед SQL и NoSQL.`  
 <blockquote>
  ...
  <blockquote>
  <p>SQL БД поддерживают транзакции  ACID , мощный язык запросов SQL! Но имеют много накладных расходов связанных с обработкой транзакций, многопоточности.</p>
 </blockquote>

 <blockquote>
  <p>Данные расходы начинают быстро препятствовать нормальной работоспособности при больших объемах обрабатываемых данных.</p>
 </blockquote>
